  ...
  <main class="main">
    ...
    <div class="product-info">
      ...
      <div class="product-share">
        ...
        <img class="product-share__img" src="@/assets/imgs/svg/Instagram-gray.svg">
        <img class="product-share__img" src="@/assets/imgs/svg/Twitter-gray.svg">
        <img class="product-share__img" src="@/assets/imgs/svg/Facebook-gray.svg">
      ...
      <div class="product-cards">
        ...
        <div class="cards__imgs">
          <img class="cards__img cards__imgs--visa" src="@/assets/imgs/svg/cards/Visa.svg">
          <img class="cards__img cards__imgs--master" src="@/assets/imgs/svg/cards/MasterCard.svg">
          <img class="cards__img cards__imgs--american" src="@/assets/imgs/svg/cards/American Express.svg">
          <img class="cards__img cards__imgs--discover" src="@/assets/imgs/svg/cards/Discover Card.svg">
          <img class="cards__img cards__imgs--union" src="@/assets/imgs/svg/cards/UnionPay.svg">
        </div>
      </div>
    </div>
  </main>
